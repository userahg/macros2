 ...
 * @author cd8unu
 */
public class MakeSensitivityReports extends StarMacro {
    
    boolean clean_up = false;
    String[] reportNames = new String[] {"Cl", "Cd", "Area_Constraint", "L_over_D"};
    String[] paramNames = new String[] {"P_TE_Thickness", "P_W_0", "P_W_1", "P_W_2", "P_W_3", "P_W_4", "P_W_5", "P_W_6", "P_W_7", "P_W_8", "P_W_9", "P_W_10", "P_W_11", "P_W_12", "P_W_13", "P_W_14", "P_W_15", "P_W_16", "P_W_17", "P_W_18", "P_W_19", "P_W_20"};
    ...
    private String getMeshAnglePlotName(ScalarGlobalParameter sgp) {
        String paramName = sgp.getPresentationName().contains("_TE_") ? "P_TE" : sgp.getPresentationName();
    ...
    private String getMeshAnglePlotTitle(ScalarGlobalParameter sgp) {
        String paramName = sgp.getPresentationName().contains("TE") ? "P_TE" : sgp.getPresentationName().replace("P_", "");
    ...
    private String getParamName(ScalarGlobalParameter sgp) {
        return sgp.getPresentationName().equals("P_TE_Thickness") ? "TE" : sgp.getPresentationName();
    }
