...
public class ParametricAirfoilSVD2302 extends StarMacro {
    ...
    private void createScenes() {
        ...
        _sim.getSceneManager().createEmptyScene("GEOM");
        ...
        _sim.getSceneManager().createGeometryScene("MESH", "Outline", "Mesh", 3);
        ...
        _sim.getSceneManager().createEmptyScene("Mach");
        ...
        _sim.getSceneManager().createEmptyScene("Pressure");
        ...
        if (type != Type.TWO_D) {
            ...
            for (ReportCostFunction rcf : _sim.get(AdjointCostFunctionManager.class).getObjectsOf(ReportCostFunction.class)) {
                ...
                _sim.getSceneManager().createEmptyScene(sceneName);
    ...
    private void setUp2DMesh(MeshOperationPart part2Mesh, PartSurface[] freestreamControlSurfaces) {
        ...
        prismLayerMesher.setLayerChoppingPercentage(10.0);
        prismLayerMesher.setNearCoreLayerAspectRatio(0.8);
        prismLayerMesher.setMinimumThickness(2.0);
