...
public class SetTablePathsAndRun extends StarMacro {
    ...
    public void execute() {
        ...
        SimDriverWorkflow starICEWorkflow = (SimDriverWorkflow) _sim.get(SimDriverWorkflowManager.class).getObject("In-Cylinder");
        starICEWorkflow.reset();
        starICEWorkflow.execute();
    }
}
